...
![ ](lilabeth_spatial_analysis_files/RECSdatafig.png)
...
![Areas included in RECS household square footage. Source: U.S. Energy Information Administration](lilabeth_spatial_analysis_files/RECSsqftfig.png)
...
```{r fig-Education-level, echo= FALSE}
...
socioeconomic_status %>% ggplot(aes(x = education, y = energy_persqft))+
  geom_boxplot()+
...
Nevertheless, well insulated households in the Northeast tend to use a lot more energy per square foot compared to other regions.This can be due to higher residential density, resulting in more multifamily buildings than detached houses.
Also, energy-related behavioral factors might play an important role in this trend.
```{r insulation-region, echo=FALSE}
...
![Deshler Park, Ohio. Source: Homes.com ](lilabeth_spatial_analysis_files/deshler-park.jpg)
