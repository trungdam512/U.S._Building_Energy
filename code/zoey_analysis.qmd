...
homes to large mansions and spanning a range of floor areas from ```range(recs %>% filter(housing_type == "Apt small building") %>% pull(TOTSQFT_EN))[1]``` to 8,501 square feet. 
