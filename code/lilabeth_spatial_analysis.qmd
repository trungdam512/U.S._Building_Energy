...
ggplot() +
  ...
  labs(title = "Median Building Age, 2011-2015",
       ...
       fill = "Median Year Built") +
    ggthemes::theme_map()
# Midwest, NE buildings tend to be older
```
Nevada has the newest buildings. Houses in the South and West generally tend to be newer. Houses in New York are oldest, along with several states in New England and the Midwest= notable Illinois, Iowa, and Ohio. 
