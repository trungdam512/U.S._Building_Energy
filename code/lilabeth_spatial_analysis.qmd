...
small_apt <- ggplot() +
  geom_sf(data = acs2015_agg, aes(fill = units_2_4/total_units)) +
        scale_fill_distiller(palette = "Oranges", 
                       direction = 1) + 
  labs(title = "Proportion of Small Apartments (2-4 Unit)",
       fill = "Proportion") + 
    ggthemes::theme_map()
...
large_apt <- ggplot() +
  geom_sf(data = acs2015_agg, aes(fill = units_5_plus/total_units)) +
        scale_fill_distiller(palette = "Oranges",
                       direction = 1) +
  labs(title = "Proportion of Large Apartments (5+ Unit)",
...
annotate_figure(units_by_state, top = text_grob("Frequency of Housing Types by State, 2011-2015",
                                      face = "bold",
                                      size = 18))
```
